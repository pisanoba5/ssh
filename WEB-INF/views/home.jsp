...
<div class="container-fluid">
  <div class="row">
   ...
   <main class="col-md-9 ms-sm-auto col-lg-10 px-md-3" style="background-image:url('/img/backGround.jpg');">
      ...
      <div class="row gx-5">
        <div class="col">
          ...
          <a href="/game/clickgame">
            <img src="/img/clickGame/clickTitle.jpg" width="100%" height="100%"/>
		  </a>
          </div>
        </div>
        <div class="col">
          <div class="p-3 border bg-light">
           ...
           <img src="/img/piheabamma/piheabammaTitle.jpg" width="100%" height="100%"/>  
           </a>
          </div>
        </div>
      </div>
