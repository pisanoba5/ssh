...
<meta name="theme-color" content="#7952b3">
    ...
    <style>
    	#screen{
           ...
           #screen.waiting{
               background-image: url("/img/clickGame/wating.jpg");
               background-size: cover;
           }
           #screen.ready1{
               background-image: url("/img/clickGame/ready1.jpg");
               background-size: cover;
                color : white;
           }
           #screen.ready2{
               background-image: url("/img/clickGame/ready2.jpg");
               background-size: cover;
                color : white;
           }
           #screen.ready3{
               background-image: url("/img/clickGame/ready3.jpg");
               background-size: cover;
                color : white;
           }
           #screen.ready4{
               background-image: url("/img/clickGame/ready4.jpg");
               background-size: cover;
                color : white;
           }
           #screen.ready5{
               background-image: url("/img/clickGame/ready5.jpg");
               background-size: cover;
                color : white;
           }
           #screen.title{
               background-image: url("/img/clickGame/clickTitle.jpg");
               background-size: cover;
           }

           #screen.explanation{
               background-image: url("/img/clickGame/explanation.jpg");
               background-size: cover;
           }

           #screen.now{
               background-image: url("/img/clickGame/click.jpg");
               background-size: cover;
           }
