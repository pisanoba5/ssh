   ...
   <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="background-image:url('/img/backGround.jpg');">
	<section class="py-5 text-center container">
	    <div class="row py-lg-5" >
	      ...
	      <img src="/img/introduce/springSecurity.png" alt="" width="350" height="100">
	      </div>
	    </div>
  </section>
	...
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">UserDetails Interface</h1>
      ...
      <div class="row">
        ...
        <div class="p-3 border bg-light">
            <img src="/img/introduce/userDetails.jpg">
            <br>
            <br>
                             사용자의 정보를 담는 UserDetils 인터페이스
             </div>
        </div>
      </div>
	 <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">UserDetailsService Interface</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
        </div>
      </div>
      <div class="row">
        <div class="col" style="text-align:center;">
          <div class="p-3 border bg-light">
            <img src="/img/introduce/userDetailsService.jpg">
             <br>
             <br>
               DB에서 User정보를 가져오는 UserDetailsService 인터페이스
             </div>
          </div>
        </div>
     <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">AuthenticationProvider  Interface</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
      ...
      <div class="row">
        <div class="col" style="text-align:center;">
        <div class="p-3 border bg-light">
            <img src="/img/introduce/authentication.jpg">
            <br>
            <br>
                            유저의 DB 정보를 비교하는 AuthenticationProvider 인터페이스, user가 입력한 정보를 담고있는 authentication를 UserDetailService에서 DB로 얻어온 user정보와 비교.
             </div>
        </div>
      </div>
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">security_context.xml</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
      ...
      <div class="row">
        <div class="col" style="text-align:center;">
        <div class="p-3 border bg-light">
            <img src="/img/introduce/security_context.jpg">
            <br>
            <br>
                          인터페이스들을 security_context.xml에 등록
             </div>
        </div>
      </div>
      </div>
