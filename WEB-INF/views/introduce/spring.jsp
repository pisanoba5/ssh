   ...
   <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="background-image:url('/img/backGround.jpg');">
	<section class="py-5 text-center container">
	    <div class="row py-lg-5" >
	      ...
	      <img src="/img/introduce/spring.png" alt="" width="350" height="100">
	      </div>
	    </div>
  </section>
      ...
      <div class="row">
        <div class="col" style="text-align:center;">
          <div class="p-3 border bg-light">
            <img src="/img/introduce/boardWrite.jpg">
             <br>
             <br>
            	  게시판에 글쓰기 페이지입니다.<br>
            	 스마트에디터를 이용하여 다양한 효과를 줄 수 있으며, 이미지 업로드도 가능합니다.
             </div>
          </div>
        </div>
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <div class="row">
        <div class="col" style="text-align:center;">
        <div class="p-3 border bg-light">
            <img src="/img/introduce/boardDetail.jpg">
            <br>
            <br>
                            게시판을 클릭하면 보이는 페이지입니다.<br>
                            댓글을 입력할 수 있고, 수정 삭제 가능합니다.
             </div>
        </div>
      </div>
	 <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Reply modify</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
      ...
      <div class="row">
        <div class="col" style="text-align:center;">
        <div class="p-3 border bg-light">
            <img src="/img/introduce/boardReplyModify.jpg">
            <br>
            <br>
                            모달을 이용하여 깔끔하게 댓글을 수정할 수 있습니다.
             </div>
        </div>
      </div>
      </div>
