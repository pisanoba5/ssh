   ...
   <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="background-image:url('/img/backGround.jpg');">
	<section class="py-5 text-center container">
	    <div class="row py-lg-5" >
	      ...
	      <img src="/img/introduce/javaScript.png" alt="" width="350" height="150">
	      </div>
	    </div>
  </section>
	...
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <div class="row">
        ...
        <div class="p-3 border bg-light">
        	<a href="/game/clickgame">
          	  <img src="/img/clickGame/clickTitle.jpg">
            </a>
            <br>
            <br>
                           클릭게임은 준비 상태에서 클릭버튼이 나오면 빠르게 클릭하여 순발력을 알아보는 게임입니다.<br>
                           총 5번 반복하고 평균시간을 기록합니다.<br>
                           비로그인으로도 플레이가 가능하지만 로그인을해야 기록이 저장되고, 게임 밑의 스코어 리스트에는 전체 10위까지의 기록이 표시됩니다.
             </div>
        </div>
      </div>
	 <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">piheabamma</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
        </div>
      </div>
      <div class="row">
        <div class="col" style="text-align:center;">
          <div class="p-3 border bg-light">
        	  <a href="/game/piheabamma">
            	<img src="/img/piheabamma/piheabamma.png">
             </a>
             <br>
             <br>
               	피해밤마 여러 장애물을 피하면서 최대한 버티는 게임입니다.<br>
               	마찬가지로 로그인을해야 기록이 저장되고, 게임 밑의 스코어 리스트에는 전체 10위까지의 기록이 표시됩니다.
             </div>
          </div>
        </div>
      </div>
