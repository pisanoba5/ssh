   ...
   <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="background-image:url('/img/backGround.jpg');">
	<section class="py-5 text-center container">
	    <div class="row py-lg-5" >
	      ...
	      <img src="/img/introduce/chartJs2.png" alt="" width="130" height="130">
	      </div>
	    </div>
  </section>
      ...
      <div class="row">
        <div class="col" style="text-align:center;">
          <div class="p-3 border bg-light">
            <img src="/img/introduce/chartJs.jpg">
             <br>
             <br>
             	 DB에서 가져온 값을 Chart.js라이브러리를 이용하여 만들었습니다.<br>
            	 로그인 후 mypage에서 확인할 수 있습니다.
             </div>
          </div>
        </div>
      </div>
