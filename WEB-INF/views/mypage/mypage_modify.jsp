...
<meta name="theme-color" content="#7952b3">
	...
	function modify(){
		...
		if(password_chk.value == ""){
	    	  alert("비밀번호확인을 입력해 주세요.");
	    	  phone.focus();
	    	  return false;
	      }
			$.ajax({
					url : "/mypage/mypage_modify",
  ...
  <div class="row">
	...
	<form id="modify_form" name="modify_form">
		  <div class="mb-3">
		    ...
		    <input type="text" class="form-control" id="id" name="id" aria-describedby="emailHelp" value="${username}" readonly>
		  </div>
		  <div class="mb-3">
		 ...
		 <input type="button" id="login_btn" name="login_btn" class="btn btn-lg btn-primary btn-block" onclick="javascript:modify();" value="회원정보변경"/>
	</form>
