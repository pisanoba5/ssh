...
$(document).ready(function(){
	...
	function goBoardDetail(boardSeq,boardHit){
			...
			if(state == "SUCCESS"){
				...
				if(listLen >  0){
					...
					for(var a=0; a<listLen; a++){
						...
						var boardNumber		= list[a].rownum;
						var boardSeq		= list[a].board_seq; 
						var boardTitle 		= list[a].board_title; 
						var boardId 		= list[a].board_id; 
						var boardHits 		= list[a].board_hits; 
						var boardDate 		= list[a].board_date;
						
						str += "<tr>";
						str += "<td>"+ boardNumber +"</td>";
											
						str += "<td  onclick='javascript:goBoardDetail("+ boardSeq +");' style='color:#28A0FF;cursor:Pointer'>" + boardTitle + "</td>";
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-3">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">게시판</h1>
        <form:form id="boardForm" name="boardForm">
      ...
      <div class= "d-grid gap-2 d-md-flex justify-content-md-end">
       <input type="button" id="boardWrite_btn" class="btn btn-primary" onclick="javascript:goBoardWrite();" value="글쓰기"/>
