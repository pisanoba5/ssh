...
<meta name="theme-color" content="#7952b3">
    ...
    function board_modify(){
    	...
    	var text = document.getElementById("board_text");
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-3">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Board Modify</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
      
        </div>
      </div>

<form id="board_form" name="board_form">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">제목</label>
    <input type="hidden" class="form-control" id="board_seq" name="board_seq"  value="${board.board_seq}"/>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="board_id" name="board_id" value="${username}" disabled/>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">내용</label>
    <textarea class="form-control" id="board_text" name="board_text" style='width: 100%; height: 412px;'>${board.board_text}</textarea>
  </div>
  <input type="button" class="btn btn-primary" onclick="javascript:board_modify();" value="수정"/>
  <input type="button" class="btn btn-danger" onclick="javascript:board_delete();" value="삭제"/>
</form>
<br>
