...
//    	System.out.println(smarteditorDto.getFiledata());
//        String callback = smarteditorDto.getCallback();
//        String callback_func = smarteditorDto.getCallback_func();
//        String file_result = "";
//        try {
//            if(smarteditorDto.getFiledata() != null && smarteditorDto.getFiledata().getOriginalFilename() != null && !smarteditorDto.getFiledata().getOriginalFilename().equals("")){
//                //파일이 존재하면
...
//		         filename_ext = filename_ext.toLowerCase();
//		         //파일 기본경로
//		         String dftFilePath = "C:" + File.separator + "project" + File.separator + "ssh" + File.separator + "src" + File.separator + "main" + File.separator + "webapp" + File.separator; 
//		         System.out.println(dftFilePath);
//
//		         //파일 기본경로 _ 상세경로
//
